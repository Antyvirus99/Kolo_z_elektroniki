...
char potwierdz_zapis_na_serwerze (void)
{
	if(memmem_P(	(const void *) odbiorcza,						//tablica w kt�rej b�dziemy szuka�
					...
					strlen_P(zapisano_na_serwerze)					//d�ugo�� tekstu szukanego					(-1 bo do tablicy dodawany jest znak ko�ca tekstu, kt�rym jest bajt o warto�ci zero)
					) != NULL
	) return 1;		
	else return 0;
}
char potwierdz_polaczenie_z_serwerem (void)
{
	if(memmem_P(	(const void *) odbiorcza,						//tablica w kt�rej b�dziemy szuka�
					...
					strlen_P(polaczono_z_serwerem)					//d�ugo�� tekstu szukanego					(-1 bo do tablicy dodawany jest znak ko�ca tekstu, kt�rym jest bajt o warto�ci zero)
					) != NULL
	) return 1;
	else return 0;	
}
char potwierdz_przesyl_adresu (void)
{
	if(memmem_P(	(const void *) odbiorcza,						//tablica w kt�rej b�dziemy szuka�
					...
					strlen_P(odebrano_bajty)					//d�ugo�� tekstu szukanego					(-1 bo do tablicy dodawany jest znak ko�ca tekstu, kt�rym jest bajt o warto�ci zero)
					) != NULL
	) return 1;	
	else return 0;
}
